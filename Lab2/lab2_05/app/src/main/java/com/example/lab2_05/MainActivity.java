...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerAdapter = new SpinnerAdapter(getApplicationContext(), R.layout.drop_down, arrayMonan);
        ...
        adapter = new ThumbnailAdapter(this, R.layout.item_thumbnail,monanGv);
